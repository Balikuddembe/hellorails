...
Build my first Hello World rails app
...
```bash
git clone https://github.com/Balikuddembe/hellorails.git
...
Feel free to check the [issues page](https://github.com/Balikuddembe/hellorails/issues).
